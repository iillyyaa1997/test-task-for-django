"""
Django settings for test_task_for_django project.
...
SECRET_KEY = '9#_)*#%6-wylseqz#&9cn&wke2^-2g=s5918g0*0dsvi+nrvl#'
...
ROOT_URLCONF = 'test_task_for_django.urls'
...
WSGI_APPLICATION = 'test_task_for_django.wsgi.application'
...
MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(BASE_DIR, "_storage/media/")
